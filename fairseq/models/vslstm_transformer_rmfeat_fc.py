...
from fairseq.modules.vslstm_rmfeat_fc import VanillaSLSTMFeat
from torch import Tensor
BufferType = Tuple[torch.Tensor, torch.Tensor]
DEFAULT_MAX_SOURCE_POSITIONS = 1024


@register_model("vslstm_tf_rmfeat_fc")
...
@register_model_architecture("vslstm_tf_rmfeat_fc", "vslstm_tf_rmfeat_fc")
...
@register_model_architecture("vslstm_tf_rmfeat_fc", "vslstm_tf_rmfeat_fc_iwslt")
...
@register_model_architecture("vslstm_tf_rmfeat_fc", "vslstm_tf_rmfeat_fc_wmt_en_de_big")
