...
@register_model("slstm_tf_feat1")
class SlstmFeatTransformerModel(FairseqEncoderDecoderModel):
...
class SLSTMEncoder(FairseqEncoder):
    ...
    def build_encoder_layer(self, args):
        ...
        return SLSTMFeat1(args)

    def forward_embedding(self, src_tokens):
        # embed tokens and positions
        x = embed = self.embed_scale * self.embed_tokens(src_tokens)
        ## in graph neural network, position embedding is not needed
...
@register_model_architecture("slstm_tf_feat1", "slstm_tf_feat1")
...
@register_model_architecture("slstm_tf_feat1", "slstm_tf_feat1_iwslt")
...
@register_model_architecture("slstm_tf_feat1", "slstm_tf_feat1_wmt_en_de_big")
