...
@register_model_architecture("slstm_tf_feat", "slstm_tf_feat")
...
@register_model_architecture("slstm_tf_feat", "slstm_tf_feat_iwslt")
...
@register_model_architecture("slstm_tf_feat", "slstm_tf_feat_wmt_en_de_big")
