...
class FeatLstmEncoder(FairseqEncoder):
    ...
    def build_encoder_layer(self, args):
        layer = MultiFeatsGenEncoderLayer(args)
...
@register_model_architecture("multifeatgen", "multifeatgen")
