...
from fairseq.modules.vslstm_rmfeat_fc4 import VanillaSLSTMFeat
from torch import Tensor
BufferType = Tuple[torch.Tensor, torch.Tensor]
DEFAULT_MAX_SOURCE_POSITIONS = 1024


@register_model("vslstm_tf_rmfeat_fc4")
...
@register_model_architecture("vslstm_tf_rmfeat_fc4", "vslstm_tf_rmfeat_fc4")
...
@register_model_architecture("vslstm_tf_rmfeat_fc4", "vslstm_tf_rmfeat_fc4_iwslt")
...
@register_model_architecture("vslstm_tf_rmfeat_fc4", "vslstm_tf_rmfeat_fc4_wmt_en_de_big")
