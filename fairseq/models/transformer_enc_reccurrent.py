...
@register_model("transformerencrec")
class TransformerEncRecModel(FairseqEncoderDecoderModel):
    """
...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        # self.layers.extend(
        #     [self.layer for i in range(args.encoder_layers)]
        # )
...
@register_model_architecture("transformerencrec", "transformerencrec")
...
@register_model_architecture("transformerencrec", "transformerencrec_iwslt_de_en")
