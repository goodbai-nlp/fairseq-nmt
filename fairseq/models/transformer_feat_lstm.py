...
class FeatLstmEncoder(FairseqEncoder):
    ...
    def build_encoder_layer(self, args):
        layer = FeatLstmEncoderLayer(args)
...
@register_model_architecture("featlstm", "featlstm")
...
@register_model_architecture("featlstm", "featlstm_wmt_en_de_big")
