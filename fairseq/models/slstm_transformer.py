...
@register_model("slstm_tf")
class SlstmTransformerModel(FairseqEncoderDecoderModel):
...
@register_model_architecture("slstm_tf", "slstm_tf")
...
@register_model_architecture("slstm_tf", "slstm_tf_base")
def slstm_tlstm_base(args):
    base_architecture(args)


@register_model_architecture("slstm_tf", "slstm_tf_iwslt")
