...
from fairseq.modules.vslstm_rmfeat import VanillaSLSTMFeat
from torch import Tensor
BufferType = Tuple[torch.Tensor, torch.Tensor]
DEFAULT_MAX_SOURCE_POSITIONS = 1024


@register_model("vslstm_tf_rmfeat")
...
@register_model_architecture("vslstm_tf_rmfeat", "vslstm_tf_rmfeat")
...
@register_model_architecture("vslstm_tf_rmfeat", "vslstm_tf_rmfeat_iwslt")
...
@register_model_architecture("vslstm_tf_rmfeat", "vslstm_tf_rmfeat_wmt_en_de_big")
