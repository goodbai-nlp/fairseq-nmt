...
@register_model_architecture("vslstm_tf_feat", "vslstm_tf_feat")
...
@register_model_architecture("vslstm_tf_feat", "vslstm_tf_feat_iwslt")
...
@register_model_architecture("vslstm_tf_feat", "vslstm_tf_feat_wmt_en_de_big")
