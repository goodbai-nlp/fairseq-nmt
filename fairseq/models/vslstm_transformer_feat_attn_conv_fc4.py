...
from fairseq.modules.vslstm_feat_attn_conv_fc4 import VanillaSLSTMFeat
from torch import Tensor
BufferType = Tuple[torch.Tensor, torch.Tensor]
DEFAULT_MAX_SOURCE_POSITIONS = 1024


@register_model("vslstm_tf_fc4_attn_conv_feat")
class VanillaSlstmFeatTransformerModel(FairseqEncoderDecoderModel):
...
@register_model_architecture("vslstm_tf_fc4_attn_conv_feat", "vslstm_tf_fc4_attn_conv_feat")
...
@register_model_architecture("vslstm_tf_fc4_attn_conv_feat", "vslstm_tf_fc4_attn_conv_feat_iwslt")
def slstm_tlstm_iwslt(args):
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 1024)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 1024)
    args.conv_kernel_size =  getattr(args, "conv_kernel_size", 5)
    base_architecture(args)
    ...
    args.weight_softmax = getattr(args, "weight_softmax", True)
    args.input_dropout = getattr(args, "input_dropout", 0.1)
    args.weight_dropout = getattr(args, "weight_dropout", args.attention_dropout)
    args.relu_dropout = getattr(args, "relu_dropout", 0.0)
    
@register_model_architecture("vslstm_tf_fc4_attn_conv_feat", "vslstm_tf_fc4_attn_conv_feat_wmt_en_de_big")
